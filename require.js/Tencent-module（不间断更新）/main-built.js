...
define('handle',['data'],function(data){
	let handle = {
		getSelfById(data,id){
...
;
define('render',['data','handle'],function(data,handle){
	let render = {
		createTreeHTML(id){
			let childs = handle.getChildsById(data,id);
			let html = "<ul>";
...
define('fulltip',['jquery'],function($){
